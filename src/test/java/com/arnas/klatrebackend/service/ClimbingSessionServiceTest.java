...
import com.arnas.klatrebackend.services.ClimbingSessionServiceDefault;
...
public class ClimbingSessionServiceTest {
    ...
    @Mock
    private GradingSystemRepositoryInterface gradingSystemRepository;
    @Mock
    ...
    void testOpenSession_Success() {
        ...
        assertNotNull(result);
        assertEquals(expectedSessionId, result.getId());
    ...
    void testAddRouteAttempt_Success() {
        ...
        Route route = new Route(routeId, "routeName", gradeId, placeId, null, false, null);
        RouteAttemptDTO routeAttemptDTO = new RouteAttemptDTO(5, true, routeId, 123456789, sessionId);
        RouteAttempt expectedAttempt = new RouteAttempt(expectedAttemptId, 5, true, routeId, 123456789, sessionId);
        RouteAttemptDisplay expectedResult = new RouteAttemptDisplay(expectedAttemptId, 5, true, "routeName", 123456789, "5a");
