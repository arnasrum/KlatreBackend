...
import com.arnas.klatrebackend.repositories.InviteRepositoryDefault;
...
public class InviteRepositoryJavaTest {
    ...
    void testRevokeInvite() {
        ...
        Assertions.assertEquals(1, revokedInvites.length);
        Assertions.assertEquals(inviteId, revokedInvites[0].getId());
