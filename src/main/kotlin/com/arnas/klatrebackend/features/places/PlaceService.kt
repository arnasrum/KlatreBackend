...
class PlaceService(
    ...
    private val gradingSystemRepository: GradeSystemRepositoryInterface,
    private val routeService: RouteRepository,
    ...
    override fun updatePlaceGradingSystem(placeId: Long, oldGradingSystemId: Long, newGradingSystemId: Long?): Long {
        ...
        val routes = routeService.getRoutesByPlace(placeId)
